...
@Component({
  ...
  styles: [`
    ...
    .user-chip { display: flex; align-items: center; gap: 12px; padding: 12px; border-radius: 12px; background: var(--color-surface-2); border: 1px solid var(--color-border); margin-bottom: 12px; }
    ...
    .logout-btn { width: 100%; display: flex; align-items: center; gap: 8px; padding: 10px 12px; border-radius: 10px; border: 1px solid rgba(239, 68, 68, 0.2); background: rgba(239, 68, 68, 0.05); color: var(--color-danger); font-size: 14px; font-weight: 600; cursor: pointer; transition: all 0.2s; }
